...
struct SettingsContentView: View {
  ...
  // AI Chat settings
  @AppStorage("chatBridgeMode") private var chatBridgeMode: String = "marrowLocal"
        ...
        VStack(alignment: .leading, spacing: 12) {
          HStack {
            ...
            Picker("", selection: $chatBridgeMode) {
              Text("Your API Keys").tag("marrowLocal")
          ...
          Text(
            chatBridgeMode == "claudeCode"
              ...
              : "Using your own API keys (set ANTHROPIC_API_KEY, OPENAI_API_KEY, or LLM_BASE_URL in your environment)."
          )
          .scaledFont(size: 12)
          .foregroundColor(OmiColors.textTertiary)
        ...
        VStack(alignment: .leading, spacing: 12) {
          ...
          Text(
            chatBridgeMode == "claudeCode"
              ...
              : "Use your own API keys (set ANTHROPIC_API_KEY, OPENAI_API_KEY, or LLM_BASE_URL in your environment)."
          )
          .scaledFont(size: 12)
          .foregroundColor(OmiColors.textTertiary)
    ...
    VStack(spacing: 20) {
      settingsCard(settingId: "about.version") {
        VStack(spacing: 16) {
          ...
          // Links
          linkRow(title: "Visit Website", url: "https://github.com/BasedHardware/omi")
          linkRow(title: "Help Center", url: "https://github.com/BasedHardware/omi/issues")
          Button(action: {
          ...
          .buttonStyle(.plain)
          linkRow(title: "Source Code", url: "https://github.com/BasedHardware/omi")
        }
      }
      ...
      .alert("Switch to Stable Channel?", isPresented: $showDowngradeAlert) {
        ...
        Button("Switch to Stable") {
          ...
          if let url = URL(string: "https://github.com/BasedHardware/omi/releases") {
            NSWorkspace.shared.open(url)
          }
        }
      } message: {
